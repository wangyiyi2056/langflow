...
export default function ShortcutsPage() {
  ...
  const colDefs: ColDef[] = [
    {
      headerName: t("settingsPage.shortcutsTable.FUNCTIONALITY"),
      field: "display_name",
      flex: 1,
      editable: false,
      resizable: false,
      valueFormatter: (params) =>
        t(`settingsPage.shortcutsTable.${toUpperSnakeCase(params.value)}`),
    }, //This column will be twice as wide as the others
    {
      headerName: t("settingsPage.shortcutsTable.KEYBOARD_SHORTCUT"),
      field: "shortcut",
      flex: 2,
      editable: false,
      resizable: false,
          ...
          <div className="align-end flex w-full justify-end">
            <div className="justify center flex items-center">
              ...
              >
                ...
                {t("settingsPage.SHORTCUTS_RESTORE")}
              </Button>
            </div>
          </div>
        </div>
